...
#---------------------------------------------------------
# Conver boolean features to factors (ie categorical features with levels {TRUE, FALSE}. 
...
data.frame(
    Truth = train$SaintsWon, 
    Fitted = predict(rf, train_X), 
    FittedProbTRUE = predict(rf, train_X, type="prob")[, 2]
)

#------------------------------
# Random Forest with 101 trees, testing 3 features at each split and keeping track of 
# variable importance
...
#-------------------------------
# Browse more properties of the odel
